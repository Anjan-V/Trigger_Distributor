        ...
        <div className="container">
          <div className="contact-info-section slide-up">
            ...
            <div className="contact-cards">
              ...
              <a href="mailto:triggerdistributor@gmail.com" className="contact-card" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                <div className="contact-icon-box"><Mail size={24} /></div>
                <div className="contact-card-info">
                  <h3>Email Us</h3>
                  <p>triggerdistributor@gmail.com</p>
                </div>
              </a>
              ...
              <a href="https://wa.me/919442100647?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20school%20supplies." target="_blank" rel="noopener noreferrer" className="contact-card" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
              ...
              <a href="https://www.google.com/maps/search/?api=1&query=10.7258,76.3888" target="_blank" rel="noopener noreferrer" className="contact-card" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
